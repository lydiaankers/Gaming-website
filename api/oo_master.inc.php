...

{
    ...
    private function setDynamicDefaults()
    {
        ...
        <h1>My Game Site</h1>
        <p class="lead">PS5 Game Reviews</p>
        JUMBO;
        $this->_dynamic_2 = "";
        $this->_dynamic_3 = <<<FOOTER
        <p>Lydia Ankers - {$tcurryear}</p>
        FOOTER;
    }
        	...
        	<div class="header clearfix">
        		<nav>
        			...
        			<ul class="nav nav-pills pull-right">
        				...
        				<li role="presentation"><a href="rank.php">Ranking Page</a></li>
        				<li role="presentation"><a href="game.php?id={$tid}">Game Page (Luckydip)</a></li>
                        <li role="presentation"><a>$tuser</a></li>
        			</ul>
        			<h3 class="text-muted"><a href="index.php">Game Review Site</a></h3>
        		</nav>
        	</div>
